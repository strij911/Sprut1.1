...
lang : {
	...
	loadingTitle : 'Выйти',
	focusTitle : 'Перенести вперед',
	fullExpandTitle : 'В натуральную величину',
	creditsText : 'Sprut1',
	creditsTitle : 'На главную',
	...
	playText : 'Просмотр',
	playTitle : 'Просмотр слайд-шоу (пробел)',
	pauseText : 'Пауза',
	pauseTitle : 'Поставить на паузу (пробел)',
	previousTitle : 'Предыдущее (стрелочка влево)',
	nextTitle : 'Следующее (стрелочка вправо)',
	moveTitle : 'Передвинуть',
	fullExpandText : 'Полный размер',
	number: 'Фото %1 из %2',
	restoreTitle : 'Щелкните, чтобы закрыть. Используйте стрелочки для навигации по фото.'
},
